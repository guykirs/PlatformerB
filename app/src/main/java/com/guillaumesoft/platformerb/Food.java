...
///  GUILLAUMESOFT
/// </summary>
class Food extends DynamicGameObject
{
    //////////////////////////////////////////////
    // CLASS STATIC VARAIBLES
    public static float FOOD_WIDTH  = 40.0f;
    public static float FOOD_HEIGHT = 40.0f;
    ...
    public void Update(float deltaTime)
    {
        ...
        bounce = (float)Math.sin(t) * BounceHeight * FOOD_HEIGHT;
    }
    ...
    public void Draw(SpriteBatcher batcher)
    {
        batcher.beginBatch(Assets.objects);
            ...
            batcher.drawSprite(position.x, position.y + bounce, FOOD_WIDTH, FOOD_HEIGHT, Assets.food);
