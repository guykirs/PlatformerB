...
///  GUILLAUMESOFT
/// </summary>
class Axe extends DynamicGameObject
{
    //////////////////////////////////////////////
    // CLASS STATIC VARAIBLES
    public static float AXE_WIDTH  = 40.0f;
    public static float AXE_HEIGHT = 40.0f;
    ...
    {
        super(x, y, AXE_WIDTH, AXE_HEIGHT);
    }
    ...
    public void Update(float deltaTime)
    {
        ...
        bounce = (float)Math.sin(t) * BounceHeight * AXE_HEIGHT;
    }
    ...
    public void Draw(SpriteBatcher batcher)
    {
        batcher.beginBatch(Assets.objects);
           ...
           batcher.drawSprite(position.x, position.y + bounce, AXE_WIDTH, AXE_HEIGHT, Assets.axe);
