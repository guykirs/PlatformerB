...
///  GUILLAUMESOFT
/// </summary>
class BullSkull extends DynamicGameObject
{
    //////////////////////////////////////////////
    // CLASS STATIC VARAIBLES
    public static float BULLSKULL_WIDTH  = 40.0f;
    public static float BULLSKULL_HEIGHT = 40.0f;
    ...
    /// </summary>
    public BullSkull(float x, float y)
    {
        super(x, y, BULLSKULL_WIDTH, BULLSKULL_HEIGHT);
    }
    ...
    public void Update(float deltaTime)
    {
        ...
        bounce = (float)Math.sin(t) * BounceHeight * BULLSKULL_HEIGHT;
    }
    ...
    public void Draw(SpriteBatcher batcher)
    {
        batcher.beginBatch(Assets.objects);
           ...
           batcher.drawSprite(position.x, position.y + bounce, BULLSKULL_WIDTH, BULLSKULL_HEIGHT, Assets.bullskull);
